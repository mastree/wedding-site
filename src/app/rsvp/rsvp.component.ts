      ...
      <div class="flex flex-col gap-5">
        ...
        <div class="flex w-full flex-col items-center">
          ...
          <div class="mt-2 flex w-full flex-col gap-1">
            <button
              ...
              class="focus:bg-light-primary rounded-lg bg-dark-secondary p-1 font-manuale font-semibold text-white ring-white focus:shadow-primary focus:ring-2 active:shadow-inner"
              #buttonYesAttend
            >
              Yes, I will attend
            </button>
        ...
        @if (willAttend) {
          <div class="flex w-full flex-col items-center">
            ...
            <div class="mt-2 flex w-full flex-row justify-between gap-1">
              ...
              <button
                (click)="onAddNumAttend(1)"
                class="active:bg-light-primary rounded-lg bg-dark-secondary px-5 py-1 font-manuale font-semibold text-white active:shadow-inner active:shadow-primary"
              >
                +
              </button>
            </div>
        ...
        <div class="flex flex-col items-center gap-2">
          ...
          <form class="flex w-full flex-col gap-2" (submit)="onSubmitMessage($event)">
            ...
            <button
              class="active:bg-light-primary rounded-lg bg-dark-secondary p-1 font-manuale font-semibold text-white active:shadow-inner active:shadow-primary"
              type="submit"
            >
              Submit
            </button>
